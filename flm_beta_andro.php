    ...
    while (true) {
        ...
        foreach ($profile as $rs) {
            if ($rs->is_private == true) {
                ...
                if ($f == 'y') {
                    $data_follow = ($proxy != '' && $proxyauth != '') ? follow_andro($id_user, $data_login, $proxy, $proxyauth) : follow_andro($id_user, $data_login);
                ...
                if ($dataid_post['status'] == 'error') {
                    ...
                    if ($l == 'y') {
                        $data_like = ($proxy != '' && $proxyauth != '') ? like_andro($id_post, $data_login, $proxy, $proxyauth) : like_andro($id_post, $data_login);
